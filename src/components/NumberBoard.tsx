        ...
        {values.map((value) => {
          ...
          return (
            <button
              ...
              className={`aspect-square min-w-0 rounded-[0.9rem] border px-0.5 py-0.5 text-center font-display text-[0.85rem] leading-none shadow-[inset_0_1px_0_rgba(255,255,255,0.55)] transition duration-200 ${
